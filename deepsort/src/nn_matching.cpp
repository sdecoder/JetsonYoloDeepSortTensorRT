...
DYNAMICM NearNeighborDisMetric::distance(const FEATURESS &features,
...
Eigen::MatrixXf NearNeighborDisMetric::_cosine_distance(const FEATURESS &a, const FEATURESS &b, bool data_is_normalized) {
  FEATURESS aa = a;
  FEATURESS bb = b;
